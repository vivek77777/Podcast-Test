...
xml_tree.SubElement(channel_element, 'fomrat').text = yaml_data['format']
...
xml_tree.SubElement(channel_element, 'itunes:icategory', {'href': link_prefix + yaml_data['category']})
